...
##############################################
def getLastReco():
    f = codecs.open(u'/home/admin/xidian-yjsy/lastReco.txt','r+','utf-8')
    recos = f.readlines()
    f.close()
    return recos[0]

def writeLastReco(reco):
    f = codecs.open(u'/home/admin/xidian-yjsy/lastReco.txt','w','utf-8')
    f.write(reco)
    f.close()
...
def mainFunc():
    ...
    params["name"] = unicode("xidian-yjsy",'utf-8')
